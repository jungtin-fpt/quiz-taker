								...
								<thead>
									<tr>
										...
										<th scope="col" colspan="2">
											<a href="${pageContext.request.contextPath}/dashboard/quizzes/create" class="btn btn-success"
												>Create new quiz</a
											>
										</th>
									</tr>
								...
								<c:forEach items="${quizzes}" var="quiz">
									<tr>
										...
										<td><a class="btn btn-outline-primary btn-sm"
										       href="<c:url value = "/dashboard/quizzes/question?id=${quiz.id}"/>">Add Question</a></td>
